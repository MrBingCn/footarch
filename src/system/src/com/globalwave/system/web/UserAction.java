...
//        }
    ...
    public String get() throws Exception {     
    	...
    	User user = userBO.get(this.id, true, true) ;
    	user.setPassword_("") ;
    ...
    public String getInfo() throws Exception {     
    	...
    	User user = userBO.get(this.id, true, false) ;
    	user.setPassword_("") ;
    ...
    public String create()  throws Exception { 
        ...
        Object newUser = userBO.create(user, organization_ids, role_ids) ;

        CodeHelper.reload("Sales") ;
    ...
    public String update()  throws Exception { 
        ...
        userBO.update(user,organization_ids, role_ids) ;
   ...
   // @Pid(value=103)
    ...
    public String login() throws Exception {
        ...
        if (isJsonRequest()) {
        	//renderObject(sessionUser, 1106L) ;// login OK('1106', '用户已经成功登录！' );
        	renderObject(sessionUser, 1106L) ;
        } else {
