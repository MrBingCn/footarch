    ...
    <td id="uploadFormTd">            
      <form  method="post" id="uploadEditForm" name="uploadEditForm" onsubmit="return false;" style="margin: 0" enctype="multipart/form-data" target="save_iframe">
	      ...
	      <table cellspacing="0" cellpadding="0" width="98%">
	        ...
	        <tr>
	          <td style="width: 80px;">浏览：<button class="ui-icon ui-icon-transferthick-e-w"  style="display: inline-block;margin: 2px;" onclick="uploader.changeChannel(this)" title="切换至单文件模式">+</button></td>
	          <td>
	        ...
	        <tr style="display:none;">
	          <td>desc_:</td>
	          <td><input type="text" name="document.desc_"/></td>
	        </tr>
	        <tr style="display:none;">
	          <td>Order:</td>
