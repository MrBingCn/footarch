...
public class ${e.className}ServiceImpl 
       extends BaseServiceImpl 
       implements ${e.className}Service {
    ...
    public void deleteAll(Long[] ids) throws Exception {
        ${e.className}Criterion criterion = new ${e.className}Criterion() ;
        criterion.setIds(ids) ;
        jdbcDao.delete(${e.className}.class, criterion) ;
    ...
    public ArrayPageList<${e.className}> query(
        ...
        return jdbcDao.query(${e.className}.class, criterion, orderList, pageIndex, pageSize);
    }
